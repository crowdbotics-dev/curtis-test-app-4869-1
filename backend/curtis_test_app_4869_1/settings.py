"""
Django settings for curtis_test_app_4869_1 project.
...
ROOT_URLCONF = 'curtis_test_app_4869_1.urls'
...
WSGI_APPLICATION = 'curtis_test_app_4869_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "curtis test app 4869 Support <support@curtis-test-app-4869-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "curtis_test_app_4869_1 API",
    "DESCRIPTION": "API documentation for curtis_test_app_4869_1 App",
    "VERSION": "v1",
}
